      ...
      <div className="w-full max-w-md bg-white p-8 rounded-[10px] border border-border shadow-sm">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          <div className="w-12 h-12 bg-structural/10 rounded-[10px] flex items-center justify-center mb-4">
            <Building2 className="w-6 h-6 text-structural" />
          </div>
          <h2 className="text-2xl font-bold text-structural">Admin Login</h2>
          <p className="text-sm text-structural-muted mt-2">
            Login to manage complaints, departments, and analytics.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="block text-sm font-medium text-structural">Admin Email</label>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 bg-structural text-white font-semibold py-2.5 rounded-[10px] shadow-sm hover:bg-structural-muted transition-colors flex items-center justify-center gap-2"
          >
